...
class QuestsControllerTest < ActionController::TestCase
  ...
  test "should create quest" do
    assert_difference('Quest.count') do
      post :create, quest: { address: @quest.address, description: @quest.description, latitude: @quest.latitude, longitude: @quest.longitude, title: @quest.title }
    end
  ...
  test "should update quest" do
    patch :update, id: @quest, quest: { address: @quest.address, description: @quest.description, latitude: @quest.latitude, longitude: @quest.longitude, title: @quest.title }
    assert_redirected_to quest_path(assigns(:quest))
  end
